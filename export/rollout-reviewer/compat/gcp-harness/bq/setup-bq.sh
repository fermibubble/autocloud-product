...
#
# The schema files are GENERATED by generate_ddl.py
# (`python3 generate_ddl.py emit-schemas`) from the exporter's data
# model, and a parity test pins them together - regenerate + re-run
# this script after a model change.
...
# Views live in their own one-time script (independently re-runnable).
"${DIR}/setup-views.sh"
